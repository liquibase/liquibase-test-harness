...
$$
BEGIN
UPDATE authors SET added = '2000-02-04 02:32:00', birthdate = '1000-02-27', email = 'test1@example.com', first_name = 'Adam', last_name = 'Gods' WHERE id = 1;
IF not found THEN
...
$$
BEGIN
UPDATE authors SET added = '1994-12-10 01:00:00', birthdate = '2000-02-27', email = 'test2@example.com', first_name = 'Noah', last_name = 'Lamekhs' WHERE id = 7;
IF not found THEN
...
$$
BEGIN
UPDATE authors SET added = '2000-12-10 01:00:00', birthdate = '3000-02-27', email = 'test3@example.com', first_name = 'Muhammad', last_name = 'Ibn Abdullah' WHERE id = 8;
IF not found THEN
