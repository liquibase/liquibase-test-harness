...
CREATE TABLE LTHDB.TESTHARNESS.products (id INT NOT NULL, name VARCHAR(100) NOT NULL, price DECIMAL(10, 2))
ALTER TABLE LTHDB.TESTHARNESS.products ADD CONSTRAINT pk_products PRIMARY KEY (id)