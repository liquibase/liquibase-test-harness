...
CREATE WAREHOUSE IF NOT EXISTS LTHDB_TEST_IF_NOT_EXISTS_WH WITH WAREHOUSE_SIZE = MEDIUM AUTO_SUSPEND = 120 AUTO_RESUME = true COMMENT = 'Duplicate creation should not fail'
