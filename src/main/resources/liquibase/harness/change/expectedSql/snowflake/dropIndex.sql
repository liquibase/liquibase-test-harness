...
DROP SCHEMA IF EXISTS TEST_DropIndex CASCADE
CREATE SCHEMA TEST_DropIndex
USE SCHEMA TEST_DropIndex
GRANT ALL PRIVILEGES ON SCHEMA TEST_DropIndex TO ROLE LIQUIBASE_TEST_HARNESS_ROLE
