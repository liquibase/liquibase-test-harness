...
CREATE TABLE LTHDB.TESTHARNESS.authors_renameview (id INT NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, email VARCHAR(100), CONSTRAINT PK_AUTHORS_RENAMEVIEW PRIMARY KEY (id))
CREATE VIEW LTHDB.TESTHARNESS.test_view AS select id, first_name, last_name, email from authors_renameview
