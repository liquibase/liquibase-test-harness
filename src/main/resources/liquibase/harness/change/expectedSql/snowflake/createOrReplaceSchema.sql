...
DROP SCHEMA IF EXISTS TEST_REPLACE_SCHEMA CASCADE
CREATE SCHEMA TEST_REPLACE_SCHEMA COMMENT = 'Initial schema to be replaced'
CREATE OR REPLACE SCHEMA TEST_REPLACE_SCHEMA COMMENT = 'Replaced schema with new configuration'