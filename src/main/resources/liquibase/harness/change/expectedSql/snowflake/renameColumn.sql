...
CREATE TABLE LTHDB.TESTHARNESS.authors (id INT NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, CONSTRAINT PK_AUTHORS PRIMARY KEY (id))
