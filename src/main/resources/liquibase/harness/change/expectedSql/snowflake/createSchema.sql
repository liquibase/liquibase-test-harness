...
DROP SCHEMA IF EXISTS TEST_BASIC_SCHEMA CASCADE
DROP SCHEMA IF EXISTS TEST_SCHEMA_WITH_REMARKS CASCADE
CREATE SCHEMA TEST_BASIC_SCHEMA
CREATE SCHEMA TEST_SCHEMA_WITH_REMARKS COMMENT = 'Basic test schema created by Liquibase'