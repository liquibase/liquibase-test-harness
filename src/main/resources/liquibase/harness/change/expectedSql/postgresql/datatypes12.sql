...
CREATE TABLE datatypes12_test_table (serial INTEGER GENERATED BY DEFAULT AS IDENTITY, bigserial BIGINT GENERATED BY DEFAULT AS IDENTITY, macaddr8 MACADDR8)
