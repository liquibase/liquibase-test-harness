CREATE TABLE IF NOT EXISTS public.autoincrement_test ("intColumn" INTEGER NOT NULL, "dateColumn" date, CONSTRAINT autoincrement_test_pkey PRIMARY KEY ("intColumn"))
