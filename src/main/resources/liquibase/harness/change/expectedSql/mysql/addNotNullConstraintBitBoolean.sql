CREATE TABLE lbcat.test_table (id INT NULL, bit_col TINYINT(1) NULL, boolean_col TINYINT(1) NULL)
INSERT INTO lbcat.test_table (id) VALUES (1)
UPDATE lbcat.test_table SET bit_col = 1 WHERE bit_col IS NULL
ALTER TABLE lbcat.test_table MODIFY bit_col TINYINT(1) NOT NULL
