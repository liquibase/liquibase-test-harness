    ...
    static OutputStream executeCommandScope(String commandName, Map<String, Object> arguments, String dbName) {
        ...
        try {
            ...
            if (commandName.equals("generateChangelog")) {
                String testResourcesPath = String.format("%s/src/test/resources/generated/liquibase/harness/generateChangelog/expectedChangeLog/%s", System.getProperty("user.dir"), dbName)  + ""
